...
# installed.
TK_PREFIX='/Users/zbchen/opt/anaconda3/envs/py36_'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/zbchen/opt/anaconda3/envs/py36_'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/zbchen/opt/anaconda3/envs/py36_/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/zbchen/opt/anaconda3/envs/py36_/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/zbchen/opt/anaconda3/envs/py36_/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/zbchen/opt/anaconda3/envs/py36_/lib/libtkstub8.6.a'
